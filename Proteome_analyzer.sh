...
~/Private/Biocomputing2022/tools/muscle -in "$1"/mcrAgene_*.fasta -out mcrA_align.fasta
~/Private/Biocomputing2022/tools/hmmbuild mcrA_HMM mcrA_align.fasta

~/Private/Biocomputing2022/tools/muscle -in "$1"/hsp70gene_*.fasta  -out hsp70_align.fasta
